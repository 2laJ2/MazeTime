...
class TestMysteerimaze(unittest.TestCase):
    ...
    def test_algoritmi_toimii_oikein_kun_option_4(self):
        ...
        labyrinth = {(20, 20): (1, 1, 1, 0), (20, 40): (1, 1, 0, 0), (20, 60): (1, 0, 0, 1), (40, 60):
         (0, 1, 1, 0), (40, 80): (1, 1, 0, 0), (40, 100): (0, 1, 0, 1), (20, 100): (1, 0, 0, 0), (20, 80):
         (1, 1, 1, 0), (20, 120): (1, 0, 0, 1), (40, 120): (0, 0, 1, 1), (60, 120): (0, 1, 1, 0), (60, 140):
         (0, 0, 0, 1), (80, 140): (0, 0, 1, 0), (100, 140): (0, 1, 0, 1), (100, 120): (0, 1, 1, 0), (80, 120)
         : (1, 0, 0, 1), (80, 100): (0, 1, 1, 0), (60, 100): (1, 0, 0, 1), (60, 80): (1, 0, 1, 0), (80, 80):
         (0, 1, 0, 1), (80, 60): (0, 1, 1, 0), (60, 60): (1, 0, 0, 1), (60, 40): (0, 1, 1, 0), (40, 40):
         (1, 0, 0, 1), (40, 20): (1, 0, 1, 0), (60, 20): (0, 0, 1, 1), (80, 20): (0, 1, 1, 0), (80, 40):
         (1, 0, 0, 1), (100, 40): (0, 1, 0, 1), (100, 20): (1, 0, 1, 0), (120, 20): (0, 0, 1, 1), (140, 20):
         (0, 0, 1, 1), (160, 20): (0, 0, 1, 1), (180, 20): (0, 1, 1, 0), (180, 40): (0, 1, 0, 0), (180, 60):
         (1, 1, 0, 0), (180, 80): (1, 1, 0, 0), (180, 100): (1, 0, 0, 1), (200, 100): (0, 1, 0, 0), (200, 80):
         (1, 1, 0, 0), (200, 60): (1, 1, 0, 0), (200, 40): (1, 1, 0, 0), (200, 20): (1, 1, 1, 0), (80, 160):
         (1, 0, 0, 1), (100, 160): (0, 0, 1, 1), (120, 160): (0, 1, 0, 1), (120, 140): (1, 1, 0, 0),
         (120, 120): (1, 0, 1, 0), (140, 120): (0, 0, 1, 1), (160, 120): (0, 1, 1, 0), (160, 140):
         (0, 1, 0, 0), (160, 160): (0, 1, 0, 1), (140, 160): (1, 0, 1, 0), (140, 180): (0, 1, 0, 1), 
         (120, 180): (1, 0, 1, 0), (120, 200): (1, 0, 0, 1), (140, 200): (0, 0, 1, 1), (160, 200):
         (0, 0, 1, 1), (180, 200): (0, 1, 0, 1), (180, 180): (0, 1, 1, 0), (160, 180): (1, 0, 1, 1),
         (200, 120): (1, 1, 0, 0), (200, 140): (0, 1, 0, 1), (180, 140): (1, 0, 0, 0), (180, 120):
         (1, 1, 1, 0), (180, 160): (1, 0, 0, 1), (200, 160): (0, 1, 1, 0), (200, 180): (1, 1, 0, 0),
         (200, 200): (1, 1, 0, 1), (40, 140): (0, 0, 1, 1), (20, 140): (1, 0, 1, 0), (20, 160): (1, 0, 0, 1),
         (40, 160): (0, 1, 1, 0), (40, 180): (1, 1, 0, 0), (40, 200): (0, 0, 0, 1), (20, 200): (1, 0, 0, 1),
         (20, 180): (1, 1, 1, 0), (60, 200): (0, 1, 0, 1), (60, 180): (1, 0, 0, 0), (60, 160): (1, 1, 1, 0),
         (80, 180): (0, 1, 1, 0), (80, 200): (1, 0, 0, 1), (100, 200): (0, 1, 0, 1), (100, 180): (1, 1, 1, 0)
         , (160, 40): (0, 0, 1, 1), (140, 40): (1, 0, 1, 0), (140, 60): (1, 0, 0, 1), (160, 60): (0, 1, 1, 0)
         , (160, 80): (1, 1, 0, 0), (160, 100): (0, 1, 0, 1), (140, 100): (0, 0, 1, 1), (120, 100):
         (0, 0, 1, 1), (100, 100): (1, 0, 0, 1), (100, 80): (1, 0, 1, 0), (120, 80): (0, 0, 0, 1), (140, 80):
         (0, 1, 1, 1), (120, 60): (0, 1, 0, 0), (120, 40): (1, 1, 1, 0), (100, 60): (1, 0, 1, 1), (140, 140):
         (1, 0, 1, 1)}
        self.assertEqual(self.algoritmi.get_visited(), labyrinth)
